...
<aside id="sidebar" class="fixed lg:static inset-y-0 -left-64 lg:left-0 z-50 w-64 bg-white rounded-2xl shadow-sm m-4 p-4 transition-all duration-300 ease-in-out overflow-y-auto">
    ...
    <nav class="mt-8 space-y-2">
        <!-- Home -->
        <a href="{{ route('dashboard') }}" class="flex items-center gap-3 px-4 py-3 text-gray-700 hover:bg-orange-50 rounded-xl transition-colors">
        ...
        <!-- Employee (Active) -->
        <a href="#" class="flex items-center gap-3 px-4 py-3 bg-orange-100 text-orange-600 rounded-xl">
            <svg class="w-5 h-5 text-orange-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <!-- Team -->
        <a href="#" class="flex items-center gap-3 px-4 py-3 text-gray-700 hover:bg-orange-50 rounded-xl transition-colors">
            <svg class="w-5 h-5 text-orange-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
