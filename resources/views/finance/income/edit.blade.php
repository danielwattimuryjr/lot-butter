...
{{ old("description", $income->description) }}</textarea
    ...
    <script>
        ...
        function updatePrice() {
            ...
            if (selectedOption.dataset.price) {
                ...
                document.getElementById('unit_price').value =
                    `Rp ${Number(currentVariantPrice).toLocaleString('id-ID')}`;
                calculateAmount();
            }
        }
        ...
        window.addEventListener('DOMContentLoaded', function () {
            ...
            const savedVariantId = '{{ old("product_variant_id", $income->product_variant_id) }}';
            if (savedVariantId) {
                document.getElementById('variant').value = savedVariantId;
                updatePrice();
                calculateAmount();
            }
        });
