...
@section("title", "Master Production Schedule - Select Product")

@section("content")
    <div class="space-y-6">
        <!-- Page Title -->
        <div>
            <h1 class="text-xl font-bold text-gray-900">Master Production Schedule</h1>
            <p class="mt-1 text-sm text-gray-600">Select a product to view its production schedule</p>
                ...
                @empty
                    <div class="flex flex-col items-center justify-center py-12">
                        ...
                        <p class="mt-1 text-sm text-gray-500">
                            Create products first to manage their production schedules.
                        </p>
                    </div>
                @endforelse
            </div>
