<div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
    ...
    <div class="flex items-center gap-2">
        ...
        <div class="relative">
            <select id="limit" class="px-3 py-2 bg-white border border-gray-200 rounded-lg text-sm text-gray-700 appearance-none pr-8 focus:outline-none focus:ring-2 focus:ring-orange-400">
